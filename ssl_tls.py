#! /usr/bin/env python
# -*- coding: UTF-8 -*-
# Author : soufiandu24@gmail.com <github.com/hacker404>
...
TLS_VERSIONS = {  "\x00\x02":"SSL_2_0",
                  "\x03\x00":"SSL_3_0",
                  "\x03\x01":"TLS_1_0",
                  "\x03\x02":"TLS_1_1",
                  "\x03\x03":"TLS_1_2",
                  
                  "\x01\x00":"PROTOCOL_DTLS_1_0_OPENSSL_PRE_0_9_8f",
                  "\xfe\xff":"DTLS_1_0",
                  "\xfe\xfd":"DTLS_1_1",
                  }
...
class TLSRecord(Packet):
    ...
    fields_desc = [ByteEnumField("content_type", 0xff, TLS_CONTENT_TYPES),
                   ...
                   StrFixedLenEnumField("version", None, 2, TLS_VERSIONS),
...
class TLSRenegotiationInfo(Packet):
    name = "TLS Extension Renegotiation Info"
    fields_desc = [
                    XFieldLenField("length", None, length_of="renegotiationg info extension", fmt="B"),
                    StrLenField("renegotiationg info extension", None, length_from=lambda x:x.length)
                  ]
...
class TLSClientHello(Packet):
    ...
    fields_desc = [
                   ...
                   ConditionalField(XFieldLenField("extensions_length", None, length_of="extensions", fmt="H"), lambda pkt:pkt.extensions_length is not None),
...
bind_layers(TLSExtension, TLSRenegotiationInfo, {'type': 0xff01})
# <--
